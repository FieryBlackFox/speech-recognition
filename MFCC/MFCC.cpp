...
std::vector<complexD> MFCC::FFT(std::vector<complexD> frame) 
{
	int n = frame.size();
	if (n == 1) 
	{
...
complexD MFCC::getWi(int i, int n)
{
	double alpha = 2 * M_PI * i / n;
	return complexD(std::cos(alpha), std::sin(alpha));
}

std::vector<double> MFCC::windowHamming(std::vector<complexD> frame)
{
	int n = frame.size();
...
std::vector<std::vector<double> > MFCC::getMelFilters(int mfccLength, int frameLength, int frequency, int frequencyMin, int frequencyMax)
{
...
std::vector<double> MFCC::logEnergySpectrum(std::vector<double> spectrum, std::vector<std::vector<double> > melFilters, int mfccCount) {
...
std::vector<double> MFCC::DCT(std::vector<double> data)
{
...
std::vector<double> MFCC::computeMFCC(std::vector<double> frame, int frequency, int mfccCount, int frequencyMin, int frequencyMax)
{
